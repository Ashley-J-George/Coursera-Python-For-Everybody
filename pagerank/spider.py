...
TABLES
Pages(id INTEGER PRIMARY KEY, url TEXT UNIQUE, html TEXT, error INTEGER, old_rank REAL, new_rank REAL)
Links(from_id INTEGER, to_id INTEGER)
Websites (url TEXT UNIQUE)
...
drop = input('Drop Existing Tables? (y/n)')
if drop == 'y':
